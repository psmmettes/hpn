#
# Perform classification on CUB Birds using Hypershperical
# Prototype Networks.
#
...
#
def parse_args():
    parser = argparse.ArgumentParser(description="CUB-200-2011 classification")
